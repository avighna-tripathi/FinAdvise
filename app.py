...
if not GROQ_API_KEY or not ALPHA_VANTAGE_API_KEY:
    st.error("API keys not found. Please set GROQ_API_KEY and ALPHA_VANTAGE_API_KEY in your .env file.")
    st.stop()
...
async def fallback(state: FinanceState) -> FinanceState:
    message = "I'm sorry, I didn't understand. You can ask me about stocks, expenses, budgets, or for financial advice."
    return {**state, "data": {"response": message}}
